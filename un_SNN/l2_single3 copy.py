...
tauMinus = 80# #20 # 30 # 33.7 from literature
aPlus = 0.0200  #tum 0.016 #9 #3 #0.5 # 0.03 from literature
aMinus = 0.0100 #255 #tum 0.012 #2.55 #2.55 #05 #0.5 # 0.0255 (=0.03*0.85) from literature 
wMax = 0.8#1 #1 # G: 0.15 1
wMaxInit = 0.2#0.5#0.1#0.100
wMin = 0
nbIter = 5
...
cell_params_lif = {'cm': 1,#70
                   'i_offset': 0.0,
                   'tau_m': 40.0,#20
                   'tau_refrac': 30.0,#2 more that t inhibit#10
                   'tau_syn_E': 2.0,#2
                   'tau_syn_I': 20.0,#5
                   'v_reset': -70.0,
                   'v_rest': -65.0,
...
AerRaw=aedatObj(filename="single3_20.aedat")
#AerRAW.save_to_mat()
#AerRaw.save_object()
